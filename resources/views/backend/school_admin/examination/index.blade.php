                                ...
                                <div class="p-2 label-input">
                                    ...
                                    <div class="single-input-modal">
                                        <input type="date" value="{{ old('date') }}" name="date"
                                            class="input-text single-input-text" id="dynamic_date" autofocus required>
                                    </div>
                                </div>
                                <div class="p-2 label-input">
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.edit-examination', function() {
            ...
            console.log(finalTerminalExamination);
            if (exam_type == 'final') {
                $('.term_exam').show();
            ...
            $('input[name="is_rank_generated"][value="' + is_rank_generated + '"]').prop(
                'checked', true);


            // If the form has an ID input field
            $('#examinationForm').attr('action',
                '{{ route('admin.examinations.update', '') }}' + '/' + id);
            $('#methodField').val('PUT');
