...
<script>
    $('#student-table').on('click', 'a.download-mark-sheet', function(e) {
        ...
        $.ajax({
            url: '/admin/mark-sheetesign/download-marksheet-design/' + studentId + '/' + classId + '/' + sectionId + '/' + marksheetDesignId,
            type: 'GET',
            xhrFields: {
        ...
        var dataTable = $('#student-table').DataTable({
            ...
            columns: [
                ...
                render: function(data, type, full, meta) {
                    ...
                    var showButton = '<a href="#" class="btn btn-primary btn-sm show-mark-sheet-design" data-student-id="' + full.id + '" data-class-id="' + full.class_id + '" data-section-id="' + full.section_id + '" data-marksheet-design-id="' + markSheetDesignId + '">Show</a>';

                    var downloadButton = '<a href="#" class="btn btn-primary btn-sm download-mark-sheet" data-student-id="' + full.id + '" data-class-id="' + full.class_id + '" data-section-id="' + full.section_id + '" data-marksheet-design-id="' + markSheetDesignId + '">Download</a>';

                    return showButton + ' ' + downloadButton;

                    // return '<button class="btn btn-primary btn-sm" onclick="downloadStudent('+data.id+')">Download</button>';
                    // '<button class="btn btn-info btn-sm ml-1" onclick="showStudent('+data.id+')">Show</button>';
                }
            }
...
<script>
    $(document).ready(function() {
        ...
        $('#student-table').on('click', 'a.show-mark-sheet-design', function(e) {
            ...
            $.ajax({
                url: baseURL + '/admin/mark-sheetesign/show-marksheet-design/' + studentId + '/' + classId + '/' + sectionId + '/' + marksheetDesignId,
                type: 'GET',
                data: {
